  ...
  return (
    <div className="app-shell">
      ...
      <footer className="footer">
        <p className="made-by">
          MADE BY KS{' '}
          <a href="https://github.com/adithiyaks" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
          ...
          <a href="https://www.linkedin.com/in/adithiaya-murugan-k-s" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
